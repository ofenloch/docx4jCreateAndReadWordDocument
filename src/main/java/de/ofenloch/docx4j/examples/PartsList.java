...
public class PartsList {
    ...
    public static String handlePkg(OpcPackage opcPackage, boolean printContentTypes) {
        ...
        // opcPackage.save( new File(System.getProperty("user.dir") +
        // "/OUT_chart_drawing.xlsx"));
    ...
    public static void printInfo(String parentName, Relationship r, Part p, StringBuilder sb, String indent) {
        ...
        if (r == null) {
            ...
            sb.append("\n" + indent + parentName + "'s " + r.getId() + " is " + p.getPartName() + " ["
                    + p.getClass().getName() + "] " + relationshipType);
        }
    ...
    public static void traverseRelationships(org.docx4j.openpackaging.packages.OpcPackage wordMLPackage,
            RelationshipsPart rp, StringBuilder sb, String indent) {
